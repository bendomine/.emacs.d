...
#+end_src
** Line Numbers
I want line numbers when programming.
#+begin_src emacs-lisp
  (add-hook 'prog-mode-hook 'display-line-numbers-mode)
#+end_src

I also prefer the current line number to be highlighted a little more strongly than it is by default, so I’ll customize the face:
...
#+RESULTS:
: [nil 0 100 0 t zone nil idle 0 nil]
